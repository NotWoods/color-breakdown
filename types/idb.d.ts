 ...
 */
export declare function openDb<DBTypes extends DBSchema | unknown = unknown>(
    name: string,
    version: number,
 ...
 * @param name Name of the database.
 */
export declare function deleteDb(
    name: string,
...
declare type IDBPDatabaseExtends = Omit<
    IDBDatabase,
    'createObjectStore' | 'deleteObjectStore' | 'transaction'
>;
export interface IDBPDatabase<DBTypes extends DBSchema | unknown = any>
     ...
     */
    transaction(
        storeNames: StoreNames<DBTypes> | StoreNames<DBTypes>[],
...
export interface IDBPTransaction<DBTypes extends DBSchema | unknown = unknown>
     ...
     */
    objectStore<StoreName extends StoreNames<DBTypes>>(
        name: StoreName,
    ): IDBPObjectStore<DBTypes, StoreName>;
}
